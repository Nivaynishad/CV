...
- Assisted licensed pharmacists in dispensing prescription medicines to
  in-patients and out-patients accurately.
- Gained hands-on exposure to inventory management, stock maintenance, and
  proper storage conditions for pharmaceutical products.
- Learned reading and interpreting prescriptions, identifying common drug
  classes, dosage forms, and routes of administration.
- Observed and supported the preparation of intravenous admixtures and basic
  compounding under supervision.
- Maintained patient records, narcotic registers, and expiry registers in
  compliance with hospital protocols.
- Interacted with patients to explain dosage instructions and basic
  precautions, while maintaining patient confidentiality.
...
- Basic knowledge of dispensing, compounding, and pharmaceutical calculations
- Familiarity with drug nomenclature (generic and brand names)
- Awareness of GMP, GPP, and basic pharmaceutical jurisprudence
...
- Patient and approachable, with genuine interest in patient welfare
- Quick learner with the ability to adapt to new environments
- Honest, sincere, and committed to professional ethics
